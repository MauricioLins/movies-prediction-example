...
def crawlerLog(file,msg,tp):
    ...
    if(platform.system() == 'Darwin'):
        ...
        location_log = r'../logs/crawler_log_'+str(dataDefault)+'-'+file+'.log'
        location_log_err = r'../logs/crawler_log_err_'+str(dataDefault)+'-'+file+'.log'
...
def kafkaLog(file,msg,tp):
    ...
    if(platform.system() == 'Darwin'):
        ...
        location_log = r'../logs/kafka_log_'+str(dataDefault)+'-'+file+'.log'
        location_log_err = r'../python/logs/kafka_err_'+str(dataDefault)+'-'+file+'.log'
...
def couchDBLog(msg,tp):
    ...
    if(platform.system() == 'Darwin'):
        ...
        location_log = r'../logs/couch_log'+str(dataDefault)+'.log'
        location_log_err = r'../logs/couch_err_'+str(dataDefault)+'.log'
